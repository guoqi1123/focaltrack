...
#####################################################################
netName = "pyConfLensFlowNetFast_iccv"
method = "experiment"
...
for i in range(len(dataset)):
	fileName = "./"+method+"_data"+"/pyConfLensFlowNetFast/iccv_calibration/"\
		+dataset[i]+".pickle"
...
offsets_range = [k*1000 for k in range(55,36,-1)]
offsets_range = [55000]
...
I = np.transpose(np.reshape(I,[-1,len(offsets_range),I.shape[1],I.shape[2],2]),[0,2,3,1,4])
